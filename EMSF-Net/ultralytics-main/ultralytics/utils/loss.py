...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask],
                       xywh=False, GIoU=False, DIoU=False, CIoU=False, EIoU=False,
                       SIoU=True, WIoU=False, Focal=False, alpha=1.2, gamma=2,ratio=1,siou_dist_weight=0.6, siou_shape_weight=0.4)
