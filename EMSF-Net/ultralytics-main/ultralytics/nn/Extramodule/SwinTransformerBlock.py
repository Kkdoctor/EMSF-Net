...
# Window Partition and Reverse Utils
...
class SwinTransformerBlock(nn.Module):
    def __init__(self, dim, num_heads, window_size=7, shift_size=None, mlp_ratio=4., qkv_bias=True, qk_scale=None,
    ...
    def calculate_mask(self, Hp, Wp, device):
