...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if verbose:
                print(f"[DEBUG] Building SwinTransformerBlock: input_channels={c2}, args={args}")
            args = [c2, *args]  # 例如 args=[256, 2] 表示 in_channels=256, num_heads=2
            m_ = SwinTransformerBlock(*args)
        ...
        m_.i, m_.f, m_.type = i + 4 if backbone else i, f, t  # attach index, 'from' index, typ
        ###Swintransformer###
